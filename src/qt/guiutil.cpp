...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Graph.lnk";
}
...
{
    return GetAutostartDir() / "graph.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Graph-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  graph-qt [" + tr("command-line options") + "]                     " + "\n";
...
{
    app.setStyleSheet("QWidget        { background: rgb(56,56,56); }"
                      "QFrame         { border: none; }"
                      ...
                      "QMenuBar       { background: rgb(56,56,56); color: rgb(110,116,126); }"
                      "QMenu          { background: rgb(75,75,75); color: rgb(222,222,222); }"
                      ...
                      "QToolButton    { background: rgb(75,75,75); color: rgb(116,122,134); border: none; border-left-color: rgb(75,75,75); border-left-style: solid; border-left-width: 6px; margin-top: 8px; margin-bottom: 8px; }"
                      "QToolButton:hover   { color: rgb(116,122,134); border: none; border-left-color: rgb(116,122,134); border-left-style: solid; border-left-width: 6px; }"
					  "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(1,212,0); border-left-style: solid; border-left-width: 6px; }"
                      ...
                      "QToolBar       { background: rgb(75,75,75); border: none; }");
}
